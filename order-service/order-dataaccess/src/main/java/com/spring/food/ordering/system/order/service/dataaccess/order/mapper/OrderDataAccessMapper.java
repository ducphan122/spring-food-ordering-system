package com.spring.food.ordering.system.order.service.dataaccess.order.mapper;
...
import com.spring.food.ordering.system.order.service.dataaccess.order.entity.OrderAddressEntity;
import com.spring.food.ordering.system.order.service.dataaccess.order.entity.OrderEntity;
import com.spring.food.ordering.system.order.service.dataaccess.order.entity.OrderItemEntity;
...
import com.spring.food.ordering.system.order.service.domain.valueobject.OrderItemId;
                ...
                .failureMessages(
                        orderEntity.getFailureMessages().isEmpty()
                                ...
                                : new ArrayList<>(Arrays.asList(orderEntity
                                        .getFailureMessages()
                                        .split(FAILURE_MESSAGE_DELIMITER)))) // Arrays.asList is
                // immutable, so we need
                // to create a new mutable
                // ArrayList
                .build();
    }
