...
import com.spring.food.ordering.system.order.service.domain.outbox.scheduler.approval.ApprovalOutboxHelper;
import com.spring.food.ordering.system.order.service.domain.outbox.scheduler.payment.PaymentOutboxHelper;
...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
    ...
    public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
        ...
        /*
         * when restaurant rejects the order, we need to trigger an event for payment service to rollback the payment changes
         */
