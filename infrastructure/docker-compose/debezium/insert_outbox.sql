...
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" SCHEMA "order";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" SCHEMA "payment";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" SCHEMA "restaurant";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" SCHEMA "customer";
...
INSERT INTO "order".payment_outbox(
	...
	VALUES ("order".uuid_generate_v4(), "order".uuid_generate_v4(), now(), now(),'OrderProcessingSaga', '{
