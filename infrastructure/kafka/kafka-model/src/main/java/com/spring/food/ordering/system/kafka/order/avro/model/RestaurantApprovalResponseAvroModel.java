...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase
    ...
    public RestaurantApprovalResponseAvroModel(
            ...
            com.spring.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus orderApprovalStatus,
    ...
    private static final org.apache.avro.Conversion<?>[] conversions = new org.apache.avro.Conversion<?>[] {
        null, null, null, null, new org.apache.avro.data.TimeConversions.TimestampMillisConversion(), null, null, null
    };
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 5:
                orderApprovalStatus =
                        (com.spring.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus) value$;
                break;
            case 6:
     ...
     */
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder
            newBuilder() {
    ...
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder
            newBuilder(
                    com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder
                            other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel
                    .Builder();
        } else {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel
                    .Builder(other);
    ...
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder
            newBuilder(
                    com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel
                    .Builder();
        } else {
    ...
    public static class Builder
            extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder setId(
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalResponseAvroModel.Builder
                clearId() {
            id = null;
        ...
        public RestaurantApprovalResponseAvroModel build() {
            try {
                ...
                record.orderApprovalStatus = fieldSetFlags()[5]
                        ...
                        : (com.spring.food.ordering.system.kafka.order.avro.model.OrderApprovalStatus)
