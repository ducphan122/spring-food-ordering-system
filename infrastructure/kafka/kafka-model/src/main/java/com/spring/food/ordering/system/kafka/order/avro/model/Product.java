...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8732148695678366232L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.spring.food.ordering.system.kafka.order.avro.model\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder() {
    return new com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder(com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder other) {
    if (other == null) {
      return new com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder();
    } else {
      return new com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder newBuilder(com.spring.food.ordering.system.kafka.order.avro.model.Product other) {
    if (other == null) {
      return new com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder();
    } else {
      return new com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.food.ordering.system.kafka.order.avro.model.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.Product.Builder clearQuantity() {
