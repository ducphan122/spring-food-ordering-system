...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase
    ...
    public PaymentRequestAvroModel(
            ...
            com.spring.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus paymentOrderStatus) {
        this.id = id;
        this.sagaId = sagaId;
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 5:
                ...
                break;
            case 6:
                paymentOrderStatus = (com.spring.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     */
    public static com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(
            com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
        } else {
     ...
     */
    public static com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder newBuilder(
            com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder();
        } else {
            return new com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setId(
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setSagaId(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCustomerId(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
                clearCustomerId() {
            customerId = null;
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setOrderId(
                java.lang.String value) {
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setPrice(
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder setCreatedAt(
         ...
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.PaymentRequestAvroModel.Builder
                setPaymentOrderStatus(com.spring.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus value) {
        ...
        public PaymentRequestAvroModel build() {
            try {
                ...
                record.paymentOrderStatus = fieldSetFlags()[6]
                        ...
                        : (com.spring.food.ordering.system.kafka.order.avro.model.PaymentOrderStatus)
