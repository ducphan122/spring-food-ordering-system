...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase
    ...
    public RestaurantApprovalRequestAvroModel(
            ...
            com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus,
            java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> products,
        ...
        switch (field$) {
            ...
            case 4:
                restaurantOrderStatus =
                        (com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus) value$;
                break;
            case 5:
                products = (java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product>) value$;
                break;
            case 6:
     ...
     */
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
            newBuilder() {
    ...
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
            newBuilder(
                    com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
                            other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
                    .Builder();
        } else {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
                    .Builder(other);
    ...
    public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
            newBuilder(
                    com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel other) {
        if (other == null) {
            return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel
                    .Builder();
        } else {
    ...
    public static class Builder
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setId(
         ...
         * @return This builder.
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
                clearId() {
            id = null;
         ...
         */
        public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder
                setProducts(java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> value) {
        ...
        public RestaurantApprovalRequestAvroModel build() {
            try {
                ...
                record.restaurantOrderStatus = fieldSetFlags()[4]
                        ...
                        : (com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus)
                                defaultValue(fields()[4]);
                record.products = fieldSetFlags()[5]
                        ? this.products
                        : (java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product>)
