...
public class RestaurantApprovalRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus;
  private java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> products;
   ...
   */
  public RestaurantApprovalRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String restaurantId, java.lang.String orderId, com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus restaurantOrderStatus, java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> products, java.math.BigDecimal price, java.time.Instant createdAt) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: restaurantOrderStatus = (com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus)value$; break;
    case 5: products = (java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product>)value$; break;
   ...
   */
  public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus getRestaurantOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setRestaurantOrderStatus(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus value) {
   ...
   */
  public java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> getProducts() {
    return products;
  }
   ...
   * @param value the value to set.
   */
  public void setProducts(java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> value) {
    this.products = value;
  }
   ...
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder() {
    return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalRequestAvroModel RecordBuilder
   */
  public static com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder newBuilder(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel other) {
    if (other == null) {
      return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder();
    } else {
      return new com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setRestaurantOrderStatus(com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearRestaurantOrderStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setProducts(java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearProducts() {
      products = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.spring.food.ordering.system.kafka.order.avro.model.RestaurantApprovalRequestAvroModel.Builder clearCreatedAt() {
    ...
    public RestaurantApprovalRequestAvroModel build() {
      try {
        ...
        record.restaurantOrderStatus = fieldSetFlags()[4] ? this.restaurantOrderStatus : (com.spring.food.ordering.system.kafka.order.avro.model.RestaurantOrderStatus) defaultValue(fields()[4]);
        record.products = fieldSetFlags()[5] ? this.products : (java.util.List<com.spring.food.ordering.system.kafka.order.avro.model.Product>) defaultValue(fields()[5]);
