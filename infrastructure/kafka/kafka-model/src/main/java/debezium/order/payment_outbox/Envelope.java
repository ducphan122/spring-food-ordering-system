...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase
     ...
     */
    public Envelope(
            debezium.order.payment_outbox.Value before,
            debezium.order.payment_outbox.Value after,
     ...
     */
    public static debezium.order.payment_outbox.Envelope.Builder newBuilder(
            debezium.order.payment_outbox.Envelope.Builder other) {
        if (other == null) {
            return new debezium.order.payment_outbox.Envelope.Builder();
        } else {
     ...
     */
    public static debezium.order.payment_outbox.Envelope.Builder newBuilder(
            debezium.order.payment_outbox.Envelope other) {
        if (other == null) {
            return new debezium.order.payment_outbox.Envelope.Builder();
        } else {
            return new debezium.order.payment_outbox.Envelope.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
         ...
         * @return This builder.
         */
        public debezium.order.payment_outbox.Envelope.Builder setBeforeBuilder(
                debezium.order.payment_outbox.Value.Builder value) {
            clearBefore();
            beforeBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public debezium.order.payment_outbox.Envelope.Builder setAfterBuilder(
                debezium.order.payment_outbox.Value.Builder value) {
            clearAfter();
            afterBuilder = value;
            return this;
         ...
         * @return This builder.
         */
        public debezium.order.payment_outbox.Envelope.Builder setSourceBuilder(
            ...
            try {
                ...
                if (beforeBuilder != null) {
                    ...
                    record.before = fieldSetFlags()[0]
                            ? this.before
                            : (debezium.order.payment_outbox.Value) defaultValue(fields()[0]);
                }
                if (afterBuilder != null) {
                    try {
                    ...
                    record.after = fieldSetFlags()[1]
                            ? this.after
                            : (debezium.order.payment_outbox.Value) defaultValue(fields()[1]);
                }
                if (sourceBuilder != null) {
                    try {
