...
public class Value extends org.apache.avro.specific.SpecificRecordBase
     ...
     */
    public static Value fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
    ...
    public Value(
            java.lang.String id,
            java.lang.String saga_id,
            java.lang.String created_at,
            java.lang.String processed_at,
            java.lang.String type,
            java.lang.String payload,
            java.lang.String outbox_status,
            java.lang.String saga_status,
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                ...
                break;
            case 1:
                saga_id = value$ != null ? value$.toString() : null;
                break;
            case 2:
                created_at = value$ != null ? value$.toString() : null;
                break;
            case 3:
                processed_at = value$ != null ? value$.toString() : null;
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            case 6:
                outbox_status = value$ != null ? value$.toString() : null;
                break;
            case 7:
                saga_status = value$ != null ? value$.toString() : null;
                break;
            case 8:
                order_status = value$ != null ? value$.toString() : null;
                break;
            case 9:
     ...
     */
    public static debezium.order.restaurant_approval_outbox.Value.Builder newBuilder(
            debezium.order.restaurant_approval_outbox.Value.Builder other) {
        if (other == null) {
            return new debezium.order.restaurant_approval_outbox.Value.Builder();
        } else {
     ...
     */
    public static debezium.order.restaurant_approval_outbox.Value.Builder newBuilder(
            debezium.order.restaurant_approval_outbox.Value other) {
        if (other == null) {
            return new debezium.order.restaurant_approval_outbox.Value.Builder();
        } else {
            return new debezium.order.restaurant_approval_outbox.Value.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
        ...
        public Value build() {
            try {
                ...
                record.processed_at =
                        fieldSetFlags()[3] ? this.processed_at : (java.lang.String) defaultValue(fields()[3]);
                ...
                record.outbox_status =
                        fieldSetFlags()[6] ? this.outbox_status : (java.lang.String) defaultValue(fields()[6]);
                record.saga_status =
                        fieldSetFlags()[7] ? this.saga_status : (java.lang.String) defaultValue(fields()[7]);
                record.order_status =
                        fieldSetFlags()[8] ? this.order_status : (java.lang.String) defaultValue(fields()[8]);
    ...
    private static final org.apache.avro.io.DatumWriter<Value> WRITER$ =
            (org.apache.avro.io.DatumWriter<Value>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    private static final org.apache.avro.io.DatumReader<Value> READER$ =
            (org.apache.avro.io.DatumReader<Value>) MODEL$.createDatumReader(SCHEMA$);
