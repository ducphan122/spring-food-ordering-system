...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase
    ...
    private static final BinaryMessageEncoder<Envelope> ENCODER = new BinaryMessageEncoder<>(MODEL$, SCHEMA$);

    private static final BinaryMessageDecoder<Envelope> DECODER = new BinaryMessageDecoder<>(MODEL$, SCHEMA$);
     ...
     */
    public Envelope(
            debezium.order.restaurant_approval_outbox.Value before,
            debezium.order.restaurant_approval_outbox.Value after,
            io.debezium.connector.postgresql.Source source,
            java.lang.String op,
            java.lang.Long ts_ms,
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 2:
                ...
                break;
            case 3:
                op = value$ != null ? value$.toString() : null;
                break;
            case 4:
     ...
     */
    public static debezium.order.restaurant_approval_outbox.Envelope.Builder newBuilder(
            debezium.order.restaurant_approval_outbox.Envelope.Builder other) {
        if (other == null) {
            return new debezium.order.restaurant_approval_outbox.Envelope.Builder();
        } else {
     ...
     */
    public static debezium.order.restaurant_approval_outbox.Envelope.Builder newBuilder(
            debezium.order.restaurant_approval_outbox.Envelope other) {
        if (other == null) {
            return new debezium.order.restaurant_approval_outbox.Envelope.Builder();
        } else {
            return new debezium.order.restaurant_approval_outbox.Envelope.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
        ...
        private Builder(debezium.order.restaurant_approval_outbox.Envelope.Builder other) {
            ...
            if (other.hasBeforeBuilder()) {
                this.beforeBuilder =
                        debezium.order.restaurant_approval_outbox.Value.newBuilder(other.getBeforeBuilder());
            }
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setBefore(
                debezium.order.restaurant_approval_outbox.Value value) {
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setBeforeBuilder(
                debezium.order.restaurant_approval_outbox.Value.Builder value) {
            clearBefore();
            beforeBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setAfter(
                debezium.order.restaurant_approval_outbox.Value value) {
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setAfterBuilder(
                debezium.order.restaurant_approval_outbox.Value.Builder value) {
            clearAfter();
            afterBuilder = value;
            return this;
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setSource(
                io.debezium.connector.postgresql.Source value) {
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setSourceBuilder(
                io.debezium.connector.postgresql.Source.Builder value) {
            clearSource();
            sourceBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public debezium.order.restaurant_approval_outbox.Envelope.Builder setTransactionBuilder(
                event.block.Builder value) {
            clearTransaction();
        ...
        public Envelope build() {
            try {
                ...
                if (beforeBuilder != null) {
                    ...
                    record.before = fieldSetFlags()[0]
                            ? this.before
                            : (debezium.order.restaurant_approval_outbox.Value) defaultValue(fields()[0]);
                }
                if (afterBuilder != null) {
                    try {
                    ...
                    record.after = fieldSetFlags()[1]
                            ? this.after
                            : (debezium.order.restaurant_approval_outbox.Value) defaultValue(fields()[1]);
                }
                if (sourceBuilder != null) {
                    try {
                    ...
                    record.source = fieldSetFlags()[2]
                            ? this.source
                            : (io.debezium.connector.postgresql.Source) defaultValue(fields()[2]);
                }
                ...
                if (transactionBuilder != null) {
                    ...
                    record.transaction =
                            fieldSetFlags()[5] ? this.transaction : (event.block) defaultValue(fields()[5]);
                }
                return record;
            } catch (org.apache.avro.AvroMissingFieldException e) {
                throw e;
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<Envelope> WRITER$ =
            (org.apache.avro.io.DatumWriter<Envelope>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<Envelope> READER$ =
            (org.apache.avro.io.DatumReader<Envelope>) MODEL$.createDatumReader(SCHEMA$);
