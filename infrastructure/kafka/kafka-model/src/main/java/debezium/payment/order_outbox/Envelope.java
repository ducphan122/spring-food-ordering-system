...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase
     ...
     */
    public Envelope(
            debezium.payment.order_outbox.Value before,
            debezium.payment.order_outbox.Value after,
     ...
     */
    public static debezium.payment.order_outbox.Envelope.Builder newBuilder(
            debezium.payment.order_outbox.Envelope.Builder other) {
        if (other == null) {
            return new debezium.payment.order_outbox.Envelope.Builder();
        } else {
     ...
     */
    public static debezium.payment.order_outbox.Envelope.Builder newBuilder(
            debezium.payment.order_outbox.Envelope other) {
        if (other == null) {
            return new debezium.payment.order_outbox.Envelope.Builder();
        } else {
            return new debezium.payment.order_outbox.Envelope.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
         ...
         * @return This builder.
         */
        public debezium.payment.order_outbox.Envelope.Builder setBeforeBuilder(
                debezium.payment.order_outbox.Value.Builder value) {
            clearBefore();
            beforeBuilder = value;
            return this;
        }
         ...
         * @return This builder.
         */
        public debezium.payment.order_outbox.Envelope.Builder setAfterBuilder(
                debezium.payment.order_outbox.Value.Builder value) {
            clearAfter();
            afterBuilder = value;
            return this;
         ...
         * @return This builder.
         */
        public debezium.payment.order_outbox.Envelope.Builder setSourceBuilder(
            ...
            try {
                ...
                if (beforeBuilder != null) {
                    ...
                    record.before = fieldSetFlags()[0]
                            ? this.before
                            : (debezium.payment.order_outbox.Value) defaultValue(fields()[0]);
                }
                if (afterBuilder != null) {
                    try {
                    ...
                    record.after = fieldSetFlags()[1]
                            ? this.after
                            : (debezium.payment.order_outbox.Value) defaultValue(fields()[1]);
                }
                if (sourceBuilder != null) {
                    try {
