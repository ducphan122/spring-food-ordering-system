...
public class Value extends org.apache.avro.specific.SpecificRecordBase
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 6:
                ...
                break;
            case 7:
                payment_status = value$ != null ? value$.toString() : null;
                break;
            case 8:
     ...
     */
    public static debezium.payment.order_outbox.Value.Builder newBuilder(
            debezium.payment.order_outbox.Value.Builder other) {
        if (other == null) {
            return new debezium.payment.order_outbox.Value.Builder();
        } else {
        ...
        public Value build() {
            try {
                ...
                record.payment_status =
                        fieldSetFlags()[7] ? this.payment_status : (java.lang.String) defaultValue(fields()[7]);
