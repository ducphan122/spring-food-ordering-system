...
public class Value extends org.apache.avro.specific.SpecificRecordBase
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            ...
            case 6:
                ...
                break;
            case 7:
                approval_status = value$ != null ? value$.toString() : null;
                break;
            case 8:
     ...
     */
    public static debezium.restaurant.order_outbox.Value.Builder newBuilder(
            debezium.restaurant.order_outbox.Value.Builder other) {
        if (other == null) {
            return new debezium.restaurant.order_outbox.Value.Builder();
        } else {
     ...
     */
    public static debezium.restaurant.order_outbox.Value.Builder newBuilder(
            debezium.restaurant.order_outbox.Value other) {
        if (other == null) {
            return new debezium.restaurant.order_outbox.Value.Builder();
        } else {
            return new debezium.restaurant.order_outbox.Value.Builder(other);
        ...
        public Value build() {
            try {
                ...
                record.approval_status =
                        fieldSetFlags()[7] ? this.approval_status : (java.lang.String) defaultValue(fields()[7]);
