...
public class Source extends org.apache.avro.specific.SpecificRecordBase
     ...
     */
    public static Source fromByteBuffer(java.nio.ByteBuffer b) throws java.io.IOException {
    ...
    public void put(int field$, java.lang.Object value$) {
        switch (field$) {
            case 0:
                ...
                break;
            case 1:
                connector = value$ != null ? value$.toString() : null;
                break;
            case 2:
            ...
            case 3:
                ...
                break;
            case 4:
                snapshot = value$ != null ? value$.toString() : null;
                break;
            case 5:
                db = value$ != null ? value$.toString() : null;
                break;
            case 6:
                sequence = value$ != null ? value$.toString() : null;
                break;
            case 7:
                schema = value$ != null ? value$.toString() : null;
                break;
            case 8:
                table = value$ != null ? value$.toString() : null;
                break;
            case 9:
     ...
     */
    public static io.debezium.connector.postgresql.Source.Builder newBuilder(
            io.debezium.connector.postgresql.Source.Builder other) {
        if (other == null) {
            return new io.debezium.connector.postgresql.Source.Builder();
        } else {
     ...
     */
    public static io.debezium.connector.postgresql.Source.Builder newBuilder(
            io.debezium.connector.postgresql.Source other) {
        if (other == null) {
            return new io.debezium.connector.postgresql.Source.Builder();
        } else {
            return new io.debezium.connector.postgresql.Source.Builder(other);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumWriter<Source> WRITER$ =
            (org.apache.avro.io.DatumWriter<Source>) MODEL$.createDatumWriter(SCHEMA$);
    ...
    @SuppressWarnings("unchecked")
    private static final org.apache.avro.io.DatumReader<Source> READER$ =
            (org.apache.avro.io.DatumReader<Source>) MODEL$.createDatumReader(SCHEMA$);
