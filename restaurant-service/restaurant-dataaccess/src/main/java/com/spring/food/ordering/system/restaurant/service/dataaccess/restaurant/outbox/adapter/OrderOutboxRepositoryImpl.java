package com.spring.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.spring.food.ordering.system.outbox.OutboxStatus;
import com.spring.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.spring.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.spring.food.ordering.system.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.spring.food.ordering.system.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.spring.food.ordering.system.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    public OrderOutboxMessage save(OrderOutboxMessage orderPaymentOutboxMessage) {
        return orderOutboxDataAccessMapper.orderOutboxEntityToOrderOutboxMessage(orderOutboxJpaRepository.save(
