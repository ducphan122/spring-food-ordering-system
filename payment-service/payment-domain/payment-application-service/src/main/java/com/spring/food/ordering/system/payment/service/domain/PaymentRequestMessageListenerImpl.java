...
public class PaymentRequestMessageListenerImpl implements PaymentRequestMessageListener {
    ...
    private void processPayment(
        ...
        do {
            log.info(
                    "Executing {} operation for {} time for order id {}",
                    methodName,
                    execution,
            ...
            try {
                ...
                log.warn(
                        "Caught OptimisticLockingFailureException exception in {} with message {}!. Retrying for order id {}!",
                        methodName,
                        e.getMessage(),
                        paymentRequest.getOrderId());
                result = false;
        ...
        if (!result) {
            throw new PaymentApplicationServiceException(
                    "Could not complete " + methodName + " operation. Throwing exception!");
        }
    }
}
